...
@section('content')
    <div class="container">
        ...
        <div class="row">
            <div class="col-10 offset-1 card border-0 shadow-sm rounded-4 overflow-hidden">
                    ...
                    <div class="row g-4 align-items-center">
                        ...
                        <div class="col-md-7">
                            <div class="mb-3 border-bottom pb-3">
                                ...
                                <span
                                    class="badge bg-warning text-white rounded-pill">{{ $product->category->name ?? 'Uncategorized' }}</span>
                            </div>
                            ...
                            <div class="row mb-3 g-3">
                                <div class="col-sm-6">
                                    <div class="p-3 bg-light rounded-3">
                                        ...
                                        <span class="fs-5 fw-bold text-dark">{{ number_format($product->price) }} <small
                                                class="text-muted fw-normal fs-6">mmk</small></span>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="p-3 bg-light rounded-3">
                                        <span class="d-block text-muted small fw-semibold text-uppercase mb-1">Current
                                            Stock</span>
                                        @if ($product->stock < 10)
                                            <span class="fs-5 fw-bold text-danger">{{ $product->stock }} <small
                                                    class="fw-normal fs-6 text-muted">(Low)</small></span>
                                        @else
